...
private:
    ...
    std::unique_ptr<ExprNode> parseMatchExpression(); // Parses match expr { pattern => body }
    std::unique_ptr<PatternNode> parsePattern(); // Parses literal, wildcard, enum, or struct pattern
