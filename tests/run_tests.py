...
def run_cmd(cmd, cwd=None):
    ...
    env = os.environ.copy()
    env["PATH"] = r"C:\Users\jaypr\scoop\apps\gcc\15.2.0\bin;" + env.get("PATH", "")
...
def main():
    ...
    ui_files = ["gallery.zen", "main.zen", "helper.zen", "test_widgets.zen", "test_npm_chart.zen", "website.zen", "test_ssr.zen", "test_game_loop.zen"]
