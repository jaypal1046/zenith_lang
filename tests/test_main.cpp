...
public:
    ...
    zenith::UIElement build() {
        return zenith::UI::Column(zenith::make_children(zenith::UI::Text(zenith::make_children(zenith::concat(label, count)), {})), {});
    }
...
zenith::UIElement ChatScreen() {
    ...
    return zenith::UI::Column(zenith::make_children(zenith::UI::Text(zenith::make_children("AI Summary:"), {{"fontWeight", zenith::toString("bold")}}), zenith::UI::Row(zenith::make_children(zenith::UI::Text(zenith::make_children(response), {}), zenith::UI::Text(zenith::make_children(full_status), {})), {})), {});
}
