...
public:
    ...
    ShowcaseSite()  {}
    ShowcaseSite(std::string title, std::string subtitle, std::string description, int clicks) : title(title), subtitle(subtitle), description(description), clicks(clicks) {}
